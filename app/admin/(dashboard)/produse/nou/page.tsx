...
export default function AdminNewProductPage() {
  ...
  const activeCategory = form.category || (catKeys[0] || "");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      size: form.size || null, colorHex: form.colorHex || null,
      imageUrl: form.images[0] || null, images: form.images,
    ...
    else { const data = await res.json(); setError(data.error || "Eroare la salvare"); }
    setSaving(false);
  };
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-neutral-100 p-6 space-y-4">
          ...
          <div>
            ...
            <textarea value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })}
              placeholder="Descrierea detaliată a produsului..." rows={4}
        ...
        <div className="bg-white rounded-2xl border border-neutral-100 p-6 space-y-4">
          ...
          <p className="font-body text-xs text-dark-400">Încarcă poze sau adaugă URL-uri. Prima imagine = poza principală.</p>
