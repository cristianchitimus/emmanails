...
const rb = (name: string, hex: string) => {
  ...
  return {
    ...
    price: 6500, category: "baza-rubber", subcategory: "baza-rubber-simple", size: "12ml",
...
const grb = (name: string, hex: string) => {
  ...
  return {
    ...
    price: 7000, category: "baza-rubber", subcategory: "baza-rubber-cu-efect", size: "12ml",
    inStock: true, featured: false, colorHex: hex,
...
const bg = (name: string, line: string, hex: string) => {
  ...
  return {
    ...
    price: 9500, category: "geluri-uv", subcategory: "gel-builder", size: "30g",
    inStock: true, featured: false, colorHex: hex,
...
const bl = (name: string, hex: string) => {
  ...
  return {
    ...
    price: 7000, category: "geluri-uv", subcategory: "gel-autonivelant", size: "12ml",
    inStock: true, featured: false, colorHex: hex,
...
const jg = (name: string, hex: string) => {
  ...
  return {
    ...
    price: 9500, category: "geluri-uv", subcategory: "gel-jelly", size: "30g",
    inStock: true, featured: false, colorHex: hex,
    imageUrl: hasSwatch ? swatch : "/emma-nails-jar-front.jpg",
    images: hasSwatch ? [swatch, "/emma-nails-jar-front.jpg"] : ["/emma-nails-jar-front.jpg"],
  };
...
const al = (name: string, hex: string) => {
  ...
  return {
    ...
    price: 9500, category: "geluri-uv", subcategory: "gel-autonivelant", size: "30g",
    inStock: true, featured: false, colorHex: hex,
    imageUrl: hasSwatch ? swatch : "/emma-nails-jar-front.jpg",
    images: hasSwatch ? [swatch, "/emma-nails-jar-front.jpg"] : ["/emma-nails-jar-front.jpg"],
  };
...
export const products = [
  ...
  // ═══════════════════════════════════════════════════════════
  { slug: "chiureta-dubla-dietter-baumann", name: "Chiuretă dublă Dietter Baumann", description: "Este un instrument dublu, format din 2 capete. Chiuretă dublă profesională Dietter Baumann, ideală pentru îndepărtarea cuticulelor și curățarea matricei unghiale. Oțel inoxidabil chirurgical de calitate superioară germană.", price: 4500, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: false, imageUrl: "/uploads/site-DSC_8288.jpg", images: ["/uploads/site-DSC_8288.jpg", "/uploads/site-DSC_8289.jpg"] },
  { slug: "cleste-profesional-dietter-baumann", name: "Clește profesional Dietter Baumann", description: "Clește profesional Dietter Baumann pentru cuticulele. Lame ascuțite din oțel chirurgical german, mâner ergonomic.", price: 16000, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: true, imageUrl: "/uploads/site-DSC_8271.jpg", images: ["/uploads/site-DSC_8271.jpg", "/uploads/site-DSC_8272.jpg", "/uploads/site-WhatsApp-Image-2024-08-22-at-08.09.53-1.jpeg"] },
  { slug: "foarfece-exclusive-staleks", name: "Foarfece Exclusive Staleks", description: "Foarfece pentru cuticulă, taie cu precizie. Lamele sunt ascuțite și subțiri, ușor curbată.", price: 13500, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: false, imageUrl: "/uploads/site-DSC_8278.jpg", images: ["/uploads/site-DSC_8278.jpg", "/uploads/site-DSC_8279.jpg", "/uploads/site-forbice-per-cuticole-staleks-exclusive-sx-221-magnolia-21mm.png"] },
  { slug: "foarfece-maniprof-110mm", name: "Foarfece Maniprof 110mm", description: "Foarfece pentru cuticulă, taie cu precizie. Lamele sunt drepte, ascuțite și subțiri. 110mm.", price: 13000, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: false, imageUrl: "/uploads/site-DSC_8273.jpg", images: ["/uploads/site-DSC_8273.jpg", "/uploads/site-DSC_8274.jpg"] },
  { slug: "foarfece-maniprof-97mm", name: "Foarfece Maniprof 97mm", description: "Foarfece pentru cuticulă, taie cu precizie. Lamele sunt drepte, ascuțite și subțiri. 97mm.", price: 13500, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: false, imageUrl: "/uploads/site-DSC_8275.jpg", images: ["/uploads/site-DSC_8275.jpg", "/uploads/site-DSC_8277.jpg"] },
  { slug: "instrument-profesional-dietter-baumann-pentru-unghii-incarnate-si-bataturi", name: "Instrument profesional Dietter Baumann pentru unghii încarnate și bătături", description: "Instrument profesional dublu, special conceput pentru tratamentul unghiilor încarnate și bătăturilor. Oțel chirurgical german.", price: 13900, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: true, imageUrl: "/uploads/site-DSC_8269.jpg", images: ["/uploads/site-DSC_8269.jpg", "/uploads/site-DSC_8267.jpg"] },
  { slug: "microforfecuta-tweezer-staleks-pro-expert", name: "Microforfecuță — Tweezer Staleks Pro Expert", description: "Instrument pentru manichiură și pedichiură. Lamele sunt ascuțite și subțiri, ușor curbată.", price: 9900, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: false, imageUrl: "/uploads/site-DSC_8280.jpg", images: ["/uploads/site-DSC_8280.jpg", "/uploads/site-DSC_8282.jpg", "/uploads/site-Tijera-para-manicure-Staleks-Expert-90-1-Enails-1-1024x1024-1.jpg"] },
  { slug: "oferta-cleste-foarfece-chiureta", name: "Ofertă clește + foarfece + chiuretă", description: "Set complet la preț special: clește + foarfece + chiuretă.", price: 34500, salePrice: 29500, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: true, imageUrl: "/uploads/site-DSC_8291.jpg", images: ["/uploads/site-DSC_8291.jpg", "/uploads/site-DSC_8293.jpg"] },
  { slug: "penseta-pedichiura-staleks-pro-podo", name: "Pensetă pedichiură Staleks Pro Podo", description: "Pentru îndepărtarea elementelor unghiilor încarnate din pliurile laterale și bătăturilor subunghiale.", price: 6500, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: false, imageUrl: "/uploads/site-DSC_8284.jpg", images: ["/uploads/site-DSC_8284.jpg", "/uploads/site-DSC_8285.jpg"] },

  // ─── INSTRUMENTE EMMA'S NAILS (5 produse noi branded) ─────
  { slug: "spatula-emma-nails", name: "Spatulă Emma's Nails", description: "Spatulă profesională branded Emma's Nails din oțel inoxidabil. Cap plat pentru împingerea cuticulelor și curățarea matricei unghiale. Mâner ergonomic cu logo Emma's Nails gravat. Livrată în cutie cadou neagră cu branding.", price: 5500, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: true, imageUrl: "/uploads/instr-DSC_4268.jpg", images: ["/uploads/instr-DSC_4268.jpg", "/uploads/instr-DSC_4271.jpg", "/uploads/instr-DSC_4273.jpg"] },
  { slug: "tweezer-emma-nails", name: "Tweezer Emma's Nails", description: "Microforfecuță tip tweezer profesională branded Emma's Nails. Lamele de precizie cu mecanism arc — taie cuticulele cu exactitate milimetrică. Oțel inoxidabil de înaltă calitate, mâner ergonomic cu grip antiderapant. Livrată în cutie cadou neagră cu branding.", price: 9900, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: true, imageUrl: "/uploads/instr-DSC_4263.jpg", images: ["/uploads/instr-DSC_4263.jpg", "/uploads/instr-DSC_4264.jpg", "/uploads/instr-DSC_4266.jpg"] },
  { slug: "pusher-emma-nails", name: "Pusher Emma's Nails", description: "Pusher profesional dublu branded Emma's Nails. Două capete funcționale cu forme diferite pentru împingerea cuticulelor și curățarea matricei. Mâner cu textură knurled pentru grip maxim. Oțel inoxidabil chirurgical. Livrat în cutie cadou neagră cu branding.", price: 5500, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: true, imageUrl: "/uploads/instr-DSC_4456.jpg", images: ["/uploads/instr-DSC_4456.jpg", "/uploads/instr-DSC_4458.jpg", "/uploads/instr-DSC_4459.jpg", "/uploads/instr-DSC_4267.jpg"] },
  { slug: "foarfece-cuticula-emma-nails", name: "Foarfece cuticulă Emma's Nails", description: "Foarfece profesionale pentru cuticulă branded Emma's Nails. Lamele subțiri și ascuțite din oțel inoxidabil, tăietură precisă și curată. Design ergonomic compact, ideal pentru manichiură de precizie. Livrate în cutie cadou neagră cu branding.", price: 12500, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: true, imageUrl: "/uploads/instr-DSC_4275.jpg", images: ["/uploads/instr-DSC_4275.jpg", "/uploads/instr-DSC_4274.jpg", "/uploads/instr-DSC_4276.jpg"] },
  { slug: "foarfece-cuticula-emma-nails-xl", name: "Foarfece cuticulă Emma's Nails XL", description: "Foarfece profesionale pentru cuticulă branded Emma's Nails — model XL cu lame mai lungi. Oțel inoxidabil de înaltă calitate, lamele ascuțite permit tăierea precisă a cuticulelor mai groase. Livrate în cutie cadou neagră cu branding.", price: 13500, category: "instrumente", subcategory: "instrumentele", inStock: true, featured: false, imageUrl: "/uploads/instr-DSC_4261.jpg", images: ["/uploads/instr-DSC_4261.jpg", "/uploads/instr-DSC_4278.jpg"] },

  // ═══════════════════════════════════════════════════════════
  // POLYGEL (19 products — unchanged)
  // ═══════════════════════════════════════════════════════════
  { slug: "polygel-emma-nails", name: "Polygel Emma Nails", description: "Cel mai top produs ever! Cu formulă revoluționară, foarte rezistent și ideal pentru construcția unghiilor pe tips/șablon/la întreținere cu schimbarea arhitecturii/french interior.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: true, imageUrl: "/uploads/site-29.jpg", images: ["/uploads/site-29.jpg"] },
  { slug: "polygel-verde", name: "Polygel Verde", description: "PolyGel verde — culoare vibrantă. Cu formulă revoluționară.", price: 3100, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-29.jpg", images: ["/uploads/site-29.jpg"] },
  { slug: "polygel-emma-nails-color-01-60g", name: "Polygel Emma Nails Color 01, 60g", description: "Cu o formulă revoluționară, foarte rezistent. Format economic 60g.", price: 14000, category: "polygel", subcategory: null, size: "60g", inStock: true, featured: true, imageUrl: "/uploads/site-1.jpg", images: ["/uploads/site-1.jpg"] },
  { slug: "polygel-emma-nails-color-06-30g", name: "Polygel Emma Nails Color 06, 30g", description: "Cu o formulă revoluționară, foarte rezistent.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-06.jpg", images: ["/uploads/site-06.jpg"] },
  { slug: "polygel-emma-nails-color-08-30g", name: "Polygel Emma Nails Color 08, 30g", description: "Cu o formulă revoluționară, foarte rezistent.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-08.jpg", images: ["/uploads/site-08.jpg"] },
  { slug: "polygel-emma-nails-color-26-30g", name: "Polygel Emma Nails Color 26, 30g", description: "Cu o formulă revoluționară, foarte rezistent.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-26.jpg", images: ["/uploads/site-26.jpg"] },
  { slug: "polygel-emma-nails-color-27-60g", name: "Polygel Emma Nails Color 27, 60g", description: "Cu o formulă revoluționară. Format economic 60g.", price: 14000, category: "polygel", subcategory: null, size: "60g", inStock: true, featured: false, imageUrl: "/uploads/site-27.jpg", images: ["/uploads/site-27.jpg"] },
  { slug: "polygel-emma-nails-color-29-30g", name: "Polygel Emma Nails Color 29, 30g", description: "Cu o formulă revoluționară, foarte rezistent.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-29.jpg", images: ["/uploads/site-29.jpg"] },
  { slug: "polygel-emma-nails-color-30-30g", name: "Polygel Emma Nails Color 30, 30g", description: "Cu o formulă revoluționară, foarte rezistent.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-30.jpg", images: ["/uploads/site-30.jpg"] },
  { slug: "polygel-emma-nails-color-32-30g", name: "Polygel Emma Nails Color 32, 30g", description: "Cu o formulă revoluționară, foarte rezistent.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-32.jpg", images: ["/uploads/site-32.jpg"] },
  { slug: "polygel-emma-nails-color-34-30g", name: "Polygel Emma Nails Color 34, 30g", description: "Cu o formulă revoluționară, foarte rezistent.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-34.jpg", images: ["/uploads/site-34.jpg"] },
  { slug: "polygel-emma-nails-color-44-30g", name: "Polygel Emma Nails Color 44, 30g", description: "Cu o formulă revoluționară, foarte rezistent.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-44.jpg", images: ["/uploads/site-44.jpg"] },
  { slug: "polygel-emma-nails-color-45-30g", name: "Polygel Emma Nails Color 45, 30g", description: "Cu o formulă revoluționară, foarte rezistent.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-45.jpg", images: ["/uploads/site-45.jpg"] },
  { slug: "polygel-emma-nails-color-kd2-30g", name: "Polygel Emma Nails Color KD2, 30g", description: "Din colecția specială KD. Cu formulă revoluționară.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-KD2.jpg", images: ["/uploads/site-KD2.jpg"] },
  { slug: "polygel-emma-nails-color-kd3-30g", name: "Polygel Emma Nails Color KD3, 30g", description: "Din colecția specială KD. Cu formulă revoluționară.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-KD3.jpg", images: ["/uploads/site-KD3.jpg"] },
  { slug: "reflective-polygel-emma-nails-color-09-30g", name: "Reflective Polygel Emma Nails Color 09, 30g", description: "PolyGel reflectiv cu efect strălucitor spectaculos.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: true, imageUrl: "/uploads/site-09.jpg", images: ["/uploads/site-09.jpg"] },
  { slug: "reflective-polygel-emma-nails-color-19-30g", name: "Reflective Polygel Emma Nails Color 19, 30g", description: "PolyGel reflectiv cu efect strălucitor unic.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-19.jpg", images: ["/uploads/site-19.jpg"] },
  { slug: "reflective-polygel-emma-nails-color-24-30g", name: "Reflective Polygel Emma Nails Color 24, 30g", description: "PolyGel reflectiv cu efect holografic.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-25.jpg", images: ["/uploads/site-25.jpg"] },
  { slug: "reflective-polygel-emma-nails-color-25-30g", name: "Reflective Polygel Emma Nails Color 25, 30g", description: "PolyGel reflectiv cu efect fascinant.", price: 8000, category: "polygel", subcategory: null, size: "30g", inStock: true, featured: false, imageUrl: "/uploads/site-25.jpg", images: ["/uploads/site-25.jpg"] },
  ...
  // ═══════════════════════════════════════════════════════════
  { slug: "glitter-vibe-top-coat-true-silver-12ml", name: "Glitter Vibe Top Coat — True Silver, 12ml", description: `${DESC.topGlitter} Nuanța True Silver — argint strălucitor.`, price: 7000, category: "top-coat", subcategory: null, size: "12ml", inStock: true, featured: false, colorHex: "#C0BCC4", imageUrl: "/glitter-vibe-top-coat-front.jpg", images: ["/glitter-vibe-top-coat-front.jpg", "/glitter-vibe-top-coat-back.jpg"] },
  { slug: "glitter-vibe-top-coat-diamond-mist-12ml", name: "Glitter Vibe Top Coat — Diamond Mist, 12ml", description: `${DESC.topGlitter} Nuanța Diamond Mist — ceață de diamant.`, price: 7000, category: "top-coat", subcategory: null, size: "12ml", inStock: true, featured: false, colorHex: "#D4CCD4", imageUrl: "/glitter-vibe-top-coat-front.jpg", images: ["/glitter-vibe-top-coat-front.jpg", "/glitter-vibe-top-coat-back.jpg"] },
  { slug: "glitter-vibe-top-coat-moon-glow-12ml", name: "Glitter Vibe Top Coat — Moon Glow, 12ml", description: `${DESC.topGlitter} Nuanța Moon Glow — strălucire lunară.`, price: 7000, category: "top-coat", subcategory: null, size: "12ml", inStock: true, featured: false, colorHex: "#D4CCC0", imageUrl: "/glitter-vibe-top-coat-front.jpg", images: ["/glitter-vibe-top-coat-front.jpg", "/glitter-vibe-top-coat-back.jpg"] },

  // ═══════════════════════════════════════════════════════════
  // TOPURI — Clear Steel (1 shade)
  // ═══════════════════════════════════════════════════════════
  { slug: "clear-steel-top-coat-12ml", name: "Clear Steel Top Coat — Clear Touch, 12ml", description: `${DESC.topSteel} Nuanța Clear Touch — claritate absolută.`, price: 7000, category: "top-coat", subcategory: null, size: "12ml", inStock: true, featured: false, colorHex: "#E4E0DC", imageUrl: "/clear-steel-top-coat-front.jpg", images: ["/clear-steel-top-coat-front.jpg", "/clear-steel-top-coat-back.jpg"] },

  // ═══════════════════════════════════════════════════════════
  // TOPURI — Velvet Matte (1 shade)
  // ═══════════════════════════════════════════════════════════
  { slug: "velvet-matte-top-coat-12ml", name: "Velvet Matte Top Coat — Velvet Touch, 12ml", description: `${DESC.topMatte} Nuanța Velvet Touch — catifea pură.`, price: 7000, category: "top-coat", subcategory: null, size: "12ml", inStock: true, featured: false, colorHex: "#E6E0DA", imageUrl: "/velvet-matte-top-coat-front.jpg", images: ["/velvet-matte-top-coat-front.jpg", "/velvet-matte-top-coat-back.jpg"] },

  // ═══════════════════════════════════════════════════════════
  // PRODUSELE AMME — Uleiuri & Spray-uri (6 produse)
  // ═══════════════════════════════════════════════════════════
  { slug: "amme-antimicotic-oil", name: "Amme — Antimicotic Oil, 100ml", description: "AMME — ANTIMICOTIC OIL\n\nIngrediente: Extract uleios de lavandă, cimbru, salvie, busuioc, mărul-lupului și uleiuri esențiale antimicrobiene.\n\nAcțiuni: Antimicotic, antibacterian, antifungic, calmant, antiinflamator. Hrănește, protejează și fortifică unghiile. Creează un mediu nefavorabil dezvoltării fungilor și bacteriilor, protejează și susține sănătatea unghiilor.\n\nIndicații: Recomandat pentru unghii fragile, predispuse la infecții bacteriene și fungice.\n\nMod de utilizare: Se aplică dimineața și seara, după spray-ul antimicotic.\n\nFără parabeni, parafine sau coloranți. A se păstra la 5–25°C. 100ml.", price: 7500, category: "produsele-amme", subcategory: "uleiuri", size: "100ml", inStock: true, featured: true, imageUrl: "/uploads/amme-antimicotic-oil.jpg", images: ["/uploads/amme-antimicotic-oil.jpg", "/uploads/amme-antimicotic-oil-back.jpg"] },
  { slug: "amme-antimicotic-spray", name: "Amme — Antimicotic Spray, 100ml", description: "AMME — ANTIMICOTIC SPRAY\n\nIngrediente: Soluție cu extract de lavandă, cimbru, salvie, busuioc, mărul-lupului și uleiuri esențiale antimicrobiene.\n\nAcțiuni: Antimicotic, antibacterian, antifungic, calmant, antiinflamator. Creează un mediu nefavorabil dezvoltării fungilor și bacteriilor, protejează și susține sănătatea unghiilor.\n\nIndicații: Recomandat pentru unghii fragile, predispuse la infecții bacteriene și fungice.\n\nMod de utilizare: Se aplică dimineața și seara, după care se recomandă aplicarea uleiului antimicotic.\n\nFără parabeni, parafine sau coloranți. A se păstra la 5–25°C. 100ml.", price: 6500, category: "produsele-amme", subcategory: "uleiuri", size: "100ml", inStock: true, featured: false, imageUrl: "/uploads/amme-antimicotic-spray.jpg", images: ["/uploads/amme-antimicotic-spray.jpg", "/uploads/amme-antimicotic-spray-back.jpg"] },
  { slug: "amme-cuticule-oil", name: "Amme — Cuticule Oil, 100ml", description: "AMME — CUTICULE OIL\n\nIngrediente: Extract uleios de lavandă, morcov și uleiuri esențiale antimicrobiene.\n\nAcțiuni: Hidratant, calmant, cicatrizant, antiseptic. Contribuie la refacerea naturală a unghiilor, oferind îngrijire delicată și eficientă cuticulelor.\n\nIndicații: Pentru cuticule uscate și deteriorate.\n\nMod de utilizare: Se aplică la baza unghiilor și se masează ușor.\n\nFără parabeni, parafine sau coloranți. A se păstra la 5–25°C. 100ml.", price: 7500, category: "produsele-amme", subcategory: "uleiuri", size: "100ml", inStock: true, featured: true, imageUrl: "/uploads/amme-cuticule-oil.jpg", images: ["/uploads/amme-cuticule-oil.jpg", "/uploads/amme-cuticule-oil-back.jpg"] },
  { slug: "amme-feet-oil", name: "Amme — Feet Oil, 100ml", description: "AMME — FEET OIL\n\nIngrediente: Extract uleios de lavandă, mentă, mărul-lupului, busuioc, salvie, turmeric și uleiuri esențiale antimicrobiene.\n\nAcțiuni: Hidratant, antimicotic, antibacterian, antiinflamator, revigorant. Calmează și regenerează pielea tălpilor.\n\nIndicații: Pentru tălpi uscate, aspre sau crăpate.\n\nMod de utilizare: Se masează ușor pe pielea curată.\n\nFără parabeni, parafine sau coloranți. A se păstra la 5–25°C. 100ml.", price: 7500, category: "produsele-amme", subcategory: "uleiuri", size: "100ml", inStock: true, featured: false, imageUrl: "/uploads/amme-feet-oil.jpg", images: ["/uploads/amme-feet-oil.jpg", "/uploads/amme-feet-oil-back.jpg"] },
  { slug: "amme-antiperspirant-feet-up-oil", name: "Amme — Antiperspirant Feet Up Oil, 100ml", description: "AMME — FEET UP OIL\n\nIngrediente: Extract uleios de lavandă, salvie, mărul-lupului, busuioc, nuc și uleiuri esențiale antimicrobiene.\n\nAcțiuni: Antiperspirant, antibacterian, calmant și revigorant. Reglează transpirația, previne disconfortul cauzat de umezeală și infecțiile provocate de transpirația excesivă, menținând pielea proaspătă și echilibrată.\n\nIndicații: Recomandat pentru picioare cu transpirație excesivă și miros neplăcut, predispuse la apariția infecțiilor cauzate de umiditate și bacterii.\n\nMod de utilizare: Se aplică seara, după spray-ul antiperspirant.\n\nFără parabeni, parafine sau coloranți. A se păstra la 5–25°C. 100ml.", price: 7500, category: "produsele-amme", subcategory: "uleiuri", size: "100ml", inStock: true, featured: false, imageUrl: "/uploads/amme-antiperspirant-feet-up-oil.jpg", images: ["/uploads/amme-antiperspirant-feet-up-oil.jpg", "/uploads/amme-antiperspirant-feet-up-oil-back.jpg"] },
  { slug: "amme-antiperspirant-feet-up-spray", name: "Amme — Antiperspirant Feet Up Spray, 100ml", description: "AMME — FEET UP SPRAY\n\nIngrediente: Soluție cu extract de lavandă, salvie, mărul-lupului, busuioc, nuc și uleiuri esențiale antimicrobiene.\n\nAcțiuni: Antiperspirant, antibacterian, calmant și revigorant. Reglează transpirația, previne disconfortul cauzat de umezeală și infecțiile provocate de transpirația excesivă, menținând pielea proaspătă și echilibrată.\n\nIndicații: Recomandat pentru picioare cu transpirație excesivă și miros neplăcut, predispuse la infecții cauzate de umiditate și bacterii.\n\nMod de utilizare: Se aplică dimineața și seara, pe pielea curată.\n\nFără parabeni, parafine sau coloranți. A se păstra la 5–25°C. 100ml.", price: 6500, category: "produsele-amme", subcategory: "uleiuri", size: "100ml", inStock: true, featured: false, imageUrl: "/uploads/amme-antiperspirant-feet-up-spray.jpg", images: ["/uploads/amme-antiperspirant-feet-up-spray.jpg", "/uploads/amme-antiperspirant-feet-up-spray-back.jpg"] },
  { slug: "amme-butter-cuticule-hand", name: "Amme — Butter Cuticule & Hand", description: "AMME — BUTTER CUTICULE & HAND\n\nIngrediente: Extract de lavandă, busuioc, unt de shea, cuișoare, oregano, lămâie, portocală și vitaminele A și E.\n\nAcțiuni: Hidratant, emolient, regenerant, calmant, antimicrobian, revitalizant. Hrănește și susține sănătatea pielii și a cuticulelor.\n\nIndicații: Pentru mâini și cuticule uscate.\n\nMod de utilizare: Se aplică pe mâini și cuticule, masând ușor până la absorbție.\n\nFără parabeni, parafine sau coloranți. A se păstra la 5–25°C.", price: 7500, category: "produsele-amme", subcategory: "uleiuri", inStock: true, featured: false, imageUrl: "/uploads/amme-antimicotic-oil.jpg", images: ["/uploads/amme-antimicotic-oil.jpg"] },
];
